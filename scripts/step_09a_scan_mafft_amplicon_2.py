...
T-2/HT-2-associated genomes are excluded from this scan.
"""
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Find Amplicon 2 candidates separating Type B chemotypes."
    )
...
SCAN_NAME = "Amplicon 2: Type B chemotype separation"
SCAN_DEFINITION = {
