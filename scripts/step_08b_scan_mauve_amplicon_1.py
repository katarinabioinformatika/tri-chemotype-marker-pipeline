...
"""Find Amplicon 1 candidates in the ProgressiveMauve TRI-core alignment."""
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Find Amplicon 1 candidates for T-2/HT-2 versus Type B in the "
...
SCAN_NAME = "Mauve Amplicon 1: T-2/HT-2 versus Type B"
SCAN_DEFINITION = {
