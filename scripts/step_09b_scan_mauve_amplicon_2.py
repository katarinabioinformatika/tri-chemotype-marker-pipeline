...
"""Find Amplicon 2 candidates within Type B genomes.

The required contrasts are DON versus NIV and 3-ADON versus 15-ADON;
T-2/HT-2-associated genomes are excluded from this ProgressiveMauve scan.
"""
...
DEFAULT_ALIGNMENT = (
    ...
    / "mauve"
    / "core_TRI_cluster"
    / "Mauve_Alignment_extraction_wrapped.fasta"
)
...
DEFAULT_OUTPUT = (
    ...
    / "mauve"
    / "amplicon_2_typeb_chemotypes_v2_terminal_site_filter"
)
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Find Amplicon 2 candidates separating Type B chemotypes in the "
            "single-LCB ProgressiveMauve TRI-core alignment."
        )
    )
...
SCAN_NAME = "Mauve Amplicon 2: Type B chemotype separation"
SCAN_DEFINITION = {
    "included_groups": {"3-ADON", "15-ADON", "NIV"},
    "contrasts": [
        (
            "don_niv",
            {"3-ADON", "15-ADON"},
